...
const sendNameAndPassword = async (name: string, password: string, session: string) => {
  return axios({
    method: 'post',
    headers: {
      'Content-Type': 'application/json',
...
const sendBirthday = async (birthday: string, session: string) => {
  return axios({
    method: 'post',
    headers: {
      'Content-Type': 'application/json',
...
const sendUsername = async (username: string, session: string) => {
  return axios({
    method: 'post',
    headers: {
      'Content-Type': 'application/json',
...
const sendAgree = async (session: string) => {
  return axios({
    method: 'post',
    headers: {
      'Content-Type': 'application/json',
